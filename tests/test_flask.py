...
def test_exceptions_request(client):
    data = {
    'recommend_on': json.dumps([]),
    'movie_exceptions': json.dumps(['62740938459a7d03615407b7', '62740938459a7d03615407b7'])}
...
def test_movie_request(client):
    data = {
    'recommend_on': json.dumps(['62740938459a7d03615407b7', '62740938459a7d03615407b7']),
    'movie_exceptions': json.dumps([])}
